...
import { Text, View, TouchableOpacity, Pressable,StyleSheet, Image, Button, SafeAreaView, ScrollView, TextInput } from 'react-native';
      ...
      <>
        ...
        <ScrollView style={styles.container}>
          ...
          { dataList.map((val, index)=>(
            <Pressable onPress={() => navigation.navigate("Details", val)} key={index} >
